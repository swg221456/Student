...
<body>
			...
			<form class="layui-form" action="">
			    ...
			    <label class="layui-form-label">选择院系:</label>
						<div class="layui-inline">
							<select id="slcollege" name="slcollege" lay-filter="sllineid">							
				...
				<button type="button" class="layui-btn layui-bg-blue" id="addartType" lay-event="addartType" lay-filter="addartType" style="margin-left: 10px;">新增专业</button>
			</form>
		</blockquote>
		<!-- 条件筛选框End -->
		...
		<div id="add-blogUser">
			<div class="artTypeLayer">
				...
				<div class="layui-form-item">
						<label class="layui-form-label">选择院系:</label>
						<div class="layui-inline">
							<select id="addmajor" name="addmajor" lay-filter="sllineid">							
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="addcollegeName" id="addcollegeName"
								lay-verify="addcollegeName" autocomplete="off" placeholder="" class="layui-input">
						</div>
					</div>
	...
	layui.use([ 'table', 'form', 'layer', 'laydate', 'laytpl', 'element' ], function() {
		...
		$("#btnselfrontinfo").click(function(){
			...
			var slcollege=$("#slcollege").val().trim();
		...
		$("#addartType").click(function(){
			...
			layer.open({
				...
				yes : function() {
					...
					$.ajax({
						type : 'get',
						url : '../college/addmajor?majorName=' + addcollegeName +'&userid='+adduserid+'&collegeid='+addmajor,
						datatype : 'json',
				...
				case 'del':
					layer.confirm('确定要删除么？', {
					  ...
					  icon:3
						...
						$.ajax({
			        		type: 'get',
			        		url: "../del/delmajor?id="+data.majorid,
			        		dataType: 'json',
			        		success:function(data){
			        			if(data.code == 0){
			        				layer.confirm(data.msg, {
