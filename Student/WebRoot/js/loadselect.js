 ...
 */
function loaduserby(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
 ...
 * @param {Object} form layui表单依赖参数form.render("select")，重新渲染
 */
function loadteach(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
		if(stageData.code == 0) {
			...
			var str = "<option value='0'>请选择</option>";
			for(var i = 0; i < stageData.data.length; i++) {
				str += '<option value=' + stageData.data[i].teacherid + '>' + stageData.data[i].teaName + '</option>';
			}
			$('#' + selectId).append(str);
			form.render("select");
		} else {
 ...
 * @param {Object} form layui表单依赖参数form.render("select")，重新渲染
 */
function loadcourseby(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
		if(stageData.code == 0) {
			...
			var str = "<option value='0'>请选择</option>";
			for(var i = 0; i < stageData.data.length; i++) {
				str += '<option value=' + stageData.data[i].courseid + '>' + stageData.data[i].curriculumName + '</option>';
			}
			$('#' + selectId).append(str);
			form.render("select");
		} else {
 ...
 * @param {Object} form layui表单依赖参数form.render("select")，重新渲染
 */
function loadcurr(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
...
function loadcollege(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
...
function loadmajor(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
...
function loadclass(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
...
function loadseme(selectId, form, reqURL){
	var reqType = 'post';
	var reqPara = {};
	var stageData = callAJAX(reqType, reqURL, reqPara)
	if(stageData != '' && stageData != undefined) {
...
function loadRoleType(selectId,form){
	...
	if(stageData != '' && stageData != undefined) {
		if(stageData.code == 0) {
			...
			for(var i = 0; i < stageData.data.length; i++){
						str += '<option value=' + stageData.data[i].roleId + '>'+ stageData.data[i].roleName +'</option>';
			 }
			$('#' + selectId).append(str);
			form.render("select");
		} else {
